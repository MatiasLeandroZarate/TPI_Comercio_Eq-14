<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageModificarPRO.aspx.cs" Inherits="TPC_Comercio_Eq_14.ABM_Proveedores.PageModificarPRO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container text-center">
    <h1 class="text-primary">Modificar Proveedores</h1>
</div>
...
<div class="container">
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <asp:TextBox ID="txtIdProveedor" runat="server" CssClass="form-control" ReadOnly="true" Enabled="False" />
        </div>
    </div>
