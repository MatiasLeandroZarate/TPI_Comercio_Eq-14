        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row justify-content-start">
                    ...
                    <div class="col-6">
                        <asp:TextBox runat="server" ID="txtFiltro" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtFiltro_TextChanged" Width="622px" />
                    </div>
                    <div class="col-4">
                        ...
                        <asp:Button ID="btnQuitarSeleccion" runat="server" CssClass="btn btn-secondary mx-2" OnClick="btnQuitarSeleccion_Click" Text="Quitar Selección" />
                    </div>
                </div>
            </div>
            <hr />
